...
char *HI_GROUPS[] = {
	...
	[SEL_LINE_NUM_COLOR]   = "SelectedLineNr",
	[OTHER_LINE_NUM_COLOR] = "OtherLineNr",
};
...
const char *HI_GROUPS_DESCR[] = {
	...
	[SEL_LINE_NUM_COLOR]   = "line number of selected item",
	[OTHER_LINE_NUM_COLOR] = "line number of inactive window",
};
...
static const col_attr_t default_cs[] = {
	...
	[SEL_LINE_NUM_COLOR]   = { -1,            -1,          -1                      },
	[OTHER_LINE_NUM_COLOR] = { -1,            -1,          -1                      },
};
